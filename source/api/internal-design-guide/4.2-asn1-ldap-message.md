...
* [4.2 - ASN/1 LDAP Grammar](#asn1-ldap-grammar)
     ...
     * [ModifyRequest](#modifyequest-operation)
...
The **Del** operation request is dscribed by this part of the **LDAP** grammar:
...
The **Del** operation response is described by this part of the **LDAP** grammar:
...
The **Modify** operation request is described by this part of the **LDAP** grammar:
...
The **Modify** operation response is described by this part of the **LDAP** grammar:
