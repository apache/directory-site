...
* [4.2 - ASN/1 LDAP Grammar](4.2-asn1-ldap-message.html#asn1-ldap-grammar)
     * [4.2.1 - LDAPMessage](4.2-asn1-ldap-message.html#LDAPMessage)
     * [4.2.2 - LDAPMessage](#BindResponse-message)
...
The structure of a **LDAP** message is described in the following chema:

![LDAPMessage](images/asn1-ldap-message.png)

It's a representation of this part of the grammar:
...
As we can see, it contains 3 **PDU**, the last one being optipnal, encapsulated into a **SEQUENCE** **PDU**.

The existing transitions are:

* **0x30** -> **0x02**                  LDAPMessage -> messageID (mandatory)
* **0x02** -> **0x0[4567]/[0-F]**       messageID -> protocolOp (mandatory)
* **NN** -> **0xA0**                    protocolOp -> controls (optional)
...
This is the simplest operation. Its **PDU** contaons only 2 bytes: **0x42 0x00**.
